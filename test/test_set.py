...
class TestSet(_TestJointOps, unittest.TestCase):
    thetype = set
    basetype = set
...
class TestBasicOpsEmpty(_TestBasicOps, unittest.TestCase):
    def setUp(self):
        self.case = "empty set"
        self.values = []
...
class TestBasicOpsSingleton(_TestBasicOps, unittest.TestCase):
    def setUp(self):
...
class TestBasicOpsTuple(_TestBasicOps, unittest.TestCase):
    def setUp(self):
...
class TestBasicOpsTriple(_TestBasicOps, unittest.TestCase):
    def setUp(self):
...
class TestBasicOpsString(_TestBasicOps, unittest.TestCase):
    def setUp(self):
...
class TestBasicOpsBytes(_TestBasicOps, unittest.TestCase):
    def setUp(self):
        self.case = "bytes set"
...
# class TestBasicOpsMixedStringBytes(_TestBasicOps, unittest.TestCase):
#     def setUp(self):
...
class TestSubsetEqualEmpty(_TestSubsets, unittest.TestCase):
    left = set()
    right = set()
    name = "both empty"
    cases = "==", "<=", ">="
...
class TestSubsetEqualNonEmpty(_TestSubsets, unittest.TestCase):
    left = set([1, 2])
    right = set([1, 2])
    name = "equal pair"
    cases = "==", "<=", ">="
...
class TestSubsetEmptyNonEmpty(_TestSubsets, unittest.TestCase):
    left = set()
    right = set([1, 2])
...
class TestSubsetPartial(_TestSubsets, unittest.TestCase):
    left = set([1])
    right = set([1, 2])
...
class TestSubsetNonOverlap(_TestSubsets, unittest.TestCase):
    left = set([1])
    right = set([2])
...
class TestOnlySetsNumeric(_TestOnlySetsInBinaryOps, unittest.TestCase):
    def setUp(self):
        self.set = set((1, 2, 3))
        self.other = 19
...
class TestOnlySetsDict(_TestOnlySetsInBinaryOps, unittest.TestCase):
    def setUp(self):
        self.set = set((1, 2, 3))
        self.other = {1: 2, 3: 4}
...
class TestOnlySetsOperator(_TestOnlySetsInBinaryOps, unittest.TestCase):
    def setUp(self):
        self.set = set((1, 2, 3))
...
class TestOnlySetsTuple(_TestOnlySetsInBinaryOps, unittest.TestCase):
    def setUp(self):
        self.set = set((1, 2, 3))
        self.other = (2, 4, 6)
        self.otherIsIterable = True
...
class TestOnlySetsString(_TestOnlySetsInBinaryOps, unittest.TestCase):
    def setUp(self):
        self.set = set((1, 2, 3))
        self.other = "abc"
        self.otherIsIterable = True
...
class TestOnlySetsGenerator(_TestOnlySetsInBinaryOps, unittest.TestCase):
    def setUp(self):
        def gen():
...
class TestCopyingEmpty(_TestCopying, unittest.TestCase):
    def setUp(self):
        self.set = set()
...
class TestCopyingSingleton(_TestCopying, unittest.TestCase):
    def setUp(self):
        self.set = set(["hello"])
...
class TestCopyingTriple(_TestCopying, unittest.TestCase):
    def setUp(self):
...
class TestCopyingTuple(_TestCopying, unittest.TestCase):
    def setUp(self):
        self.set = set([(1, 2)])
...
class TestCopyingNested(_TestCopying, unittest.TestCase):
    def setUp(self):
